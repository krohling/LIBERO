# python ppo_continuous_action_libero.py --num_envs 5 --num_steps 600 --save_videos --track
...
#         self.actor_mean = make_policy('./actor_config.json')
...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, x, action=None):
        ...
        return action, action_log_prob, entropy, self.critic(x)
